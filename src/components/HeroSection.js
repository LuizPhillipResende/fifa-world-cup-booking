    ...
    <section className="relative w-full overflow-hidden bg-gradient-to-r from-bg-base via-[#0f171e] to-[#162521] px-6 py-20 lg:px-24 border-b border-white/5">
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <p className="max-w-2xl text-lg text-gray-400 mb-12 leading-relaxed">
          Garanta seu lugar na maior competição de futebol do planeta. EUA,
          Canadá e México recebem 48 seleções em 104 jogos épicos.
        </p>
        ...
        <div className="flex flex-wrap gap-12">
          <div>
            ...
            <div className="text-sm font-medium tracking-widest text-gray-500 uppercase mt-1">
              Jogos
            </div>
          </div>
          <div>
